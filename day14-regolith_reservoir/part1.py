...
class Cave:
    ...
    def AddSand(self):
        ...
        move = True
        while move:
            if (self.sand_x, self.sand_y+1) not in self.map and (self.sand_x, self.sand_y+1) not in self.sand:
                self.sand_y += 1
            elif (self.sand_x-1, self.sand_y+1) not in self.map and (self.sand_x-1, self.sand_y+1) not in self.sand:
                self.sand_x -= 1
                self.sand_y += 1
            elif (self.sand_x+1, self.sand_y+1) not in self.map and (self.sand_x+1, self.sand_y+1) not in self.sand:
                self.sand_x += 1
        ...
        if (self.x_min <= self.sand_x <= self.x_max) and (self.y_min <= self.sand_y <= self.y_max):
